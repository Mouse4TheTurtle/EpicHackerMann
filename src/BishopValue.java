...
public class BishopValue {
    ...
    public double blackBishopPlacementValue() {
        ...
        blackBishopPlacementValueTotal =+ blackBishopPlacementValue1 +blackBishopPlacementValue2;
        return blackBishopPlacementValueTotal;
    }
